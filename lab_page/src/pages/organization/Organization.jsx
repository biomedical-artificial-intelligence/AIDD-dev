...
const nodeData = {
  'Data': [
    { 부서: 'Data', 성명: '최주원', 담당업무: "1. Patient's Data Collection 2. Whole RNA seq. 3. Data Analysis" },
  ...
  'Development': [
    ...
    { 부서: 'Development', 성명: '강정호', 담당업무: '1. PPI simulation system development 2. HPC management 3. Prediction Modeling 4. system and algorithm development' },
  ],
  'in Silico': [
  ...
  'in Vitro': [
    ...
    { 부서: 'in Vitro', 성명: '김민정', 담당업무: '1. ELISA affinity test 2. in vitro cell test 3. ADMET test' },
  ],
  'in Vivo': [
